...
b. 
```{r pca-loadings-plot, message=FALSE, warning=FALSE}
library(tidyverse)
library(tidymodels)
library(janitor)
...
# Extract PCA loadings from the PCA step
pca_step <- pca_prep$steps[[which(map_chr(pca_prep$steps, class) == "step_pca")]]
...
# Plot the top 6 PCs' nutrient loadings
