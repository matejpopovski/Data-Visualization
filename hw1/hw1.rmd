...
> Looking at the first plot I cannot see large visible variation in the flight speeds accross carriers. However, if we sort them (second plot), the difference between YV and HA is not that small. 
