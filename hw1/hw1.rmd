...
> Looking at the first plot there is no large variance in the flight speeds accross carriers. However, if we sort them (second plot), the difference between YV and HA is not that small. 
